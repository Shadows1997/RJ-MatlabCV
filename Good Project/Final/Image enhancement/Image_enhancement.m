...
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, 'gui_Singleton',  gui_Singleton, 'gui_OpeningFcn', @Image_enhancement_OpeningFcn, 'gui_OutputFcn',  @Image_enhancement_OutputFcn, 'gui_LayoutFcn',  [] , 'gui_Callback',   []);
...
% --- Otherwise, executes on mouse press in 5 pixel border or over medianfilter.
function medianfilter_ButtonDownFcn(hObject, eventdata, handles)
