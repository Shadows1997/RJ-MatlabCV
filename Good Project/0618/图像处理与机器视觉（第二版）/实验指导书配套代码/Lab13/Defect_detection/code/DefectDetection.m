function varargout = DefectDetection(varargin)
% DEFECTDETECTION MATLAB code for DefectDetection.fig
%      DEFECTDETECTION, by itself, creates a new DEFECTDETECTION or raises the existing
%      singleton*.
%
%      H = DEFECTDETECTION returns the handle to a new DEFECTDETECTION or the handle to
%      the existing singleton*.
%
%      DEFECTDETECTION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DEFECTDETECTION.M with the given input arguments.
%
%      DEFECTDETECTION('Property','Value',...) creates a new DEFECTDETECTION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DefectDetection_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DefectDetection_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DefectDetection

% Last Modified by GUIDE v2.5 16-Jun-2021 11:13:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DefectDetection_OpeningFcn, ...
                   'gui_OutputFcn',  @DefectDetection_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DefectDetection is made visible.
function DefectDetection_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DefectDetection (see VARARGIN)
handles.input = 0;
handles.img = [];
...
% Choose default command line output for DefectDetection
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes DefectDetection wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DefectDetection_OutputFcn(hObject, eventdata, handles) 
