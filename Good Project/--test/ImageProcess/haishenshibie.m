function varargout = haishenshibie(varargin)
% HAISHENSHIBIE MATLAB code for haishenshibie.fig
%      HAISHENSHIBIE, by itself, creates a new HAISHENSHIBIE or raises the existing
%      singleton*.
%
%      H = HAISHENSHIBIE returns the handle to a new HAISHENSHIBIE or the handle to
%      the existing singleton*.
%
%      HAISHENSHIBIE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HAISHENSHIBIE.M with the given input arguments.
%
%      HAISHENSHIBIE('Property','Value',...) creates a new HAISHENSHIBIE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before haishenshibie_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to haishenshibie_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help haishenshibie

% Last Modified by GUIDE v2.5 11-Mar-2021 20:30:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @haishenshibie_OpeningFcn, ...
                   'gui_OutputFcn',  @haishenshibie_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before haishenshibie is made visible.
function haishenshibie_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to haishenshibie (see VARARGIN)

% Choose default command line output for haishenshibie
...
% UIWAIT makes haishenshibie wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = haishenshibie_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(haishenshibie);% //想关闭的matlab界面名称——对应gui.m和gui.fig
set(haishenshibie1,'Visible','on'); % //想打开的界面名称——gui.m和gui.fig
