...
class FirstUi(QMainWindow):  # 第一个窗口类
    ...
    def init_ui(self):
        ...
        self.label_name = QLabel('大连睿景时代', self)
        self.label_name.setGeometry(460, 410, 200, 30)
        self.label_name = QLabel('版权所有', self)
...
class write_num(QWidget):
    ...
    def __InitView(self):
        ...
        self.label_name = QLabel('高级视觉实验', self)
        self.label_name.setGeometry(500, 35, 100, 30)

        self.label_name = QLabel('手写数字识别', self)
        self.label_name.setGeometry(500, 65, 100, 30)

        self.label_name = QLabel('识别结果见下列文本框', self)
...
class picture_num(QWidget):
    ...
    def init_ui(self):
        ...
        self.label_name1 = QLabel('大连睿景时代', self)
        self.label_name1.setGeometry(500, 20, 120, 35)

        self.label_name2 = QLabel('高级视觉实验', self)
        self.label_name2.setGeometry(500, 60, 100, 35)

        self.label_name3 = QLabel('图片数字识别', self)
        self.label_name3.setGeometry(500, 100, 100, 35)

        self.label_name4 = QLabel('结果见下列文本框', self)
